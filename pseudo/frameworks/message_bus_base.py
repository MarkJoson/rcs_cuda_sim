...
class MessageBusBase(ABC):
    ...
    def createPublisher(
        ...
        tensor_id: MessageID,                     # 发布Tensor的消息Id
        shape: TensorShape,                         # 发布Tensor的形状
        max_history_len: int,                       # 期望的历史队列长度
    ...
    def createSubscriber(
        ...
        tensor_id: MessageID,                     # 接收Tensor的消息Id
        shape: TensorShape,                         # 接收Tensor的形状
